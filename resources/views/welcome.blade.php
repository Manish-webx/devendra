...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Get the fastest Satta King live results and daily updated charts for all top locations.">
        <!-- Fonts -->
    ...
    <body class="font-sans antialiased bg-gray-100">
        ...
        <div class="bg-black text-yellow-500 text-center py-4 shadow-lg border-b-4 border-yellow-600">
            ...
            <div class="mt-2 text-white flex justify-center gap-4">
                ...
                @auth
                    <a href="{{ route('admin.results.index') }}" class="hover:text-yellow-400 font-bold">ADMIN PANEL</a>
                @else
                    <a href="{{ route('login') }}" class="hover:text-yellow-400 font-bold">LOGIN</a>
                @endauth
            </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 mb-8 border border-gray-200">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    ...
                    <div class="border-2 border-gray-300 rounded-lg p-3 text-center bg-gray-50 hover:bg-gray-100 transition-colors shadow-sm">
                        ...
                        @endphp
                        <div class="text-3xl font-extrabold {{ $todayNumber === 'WAIT' ? 'text-red-500' : 'text-green-600' }}">
                            {{ $todayNumber }}
                        </div>
                    </div>
                    @endforeach
            ...
            <!-- Month Selection -->
            <div class="text-center mb-6">
                <form method="GET" action="{{ route('home') }}" class="inline-flex items-center gap-2 bg-white p-3 rounded shadow">
            ...
            <!-- Monthly Chart -->
            <div class="bg-black text-yellow-500 text-center py-2 font-bold text-xl uppercase rounded-t-lg border-2 border-black">
